...
//	cout<<endl<< "# non-vetoed trigs:"<< setw(12) << tot_trigs;
	...
	printf("\n                 Scaler     TDC     ADC");
	printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
	printf("\nBottom dEa   : %8.2f%8.2f%8.2f", sTot_B_dEa	/ (float)sync_time_sec, metadata.n_tdc_hits_B_dEa	/ (float)run_time_sec, metadata.n_adc_hits_B_dEa	/ (float)run_time_sec);
	printf("\nBottom dEb   : %8.2f%8.2f%8.2f", sTot_B_dEb	/ (float)sync_time_sec, metadata.n_tdc_hits_B_dEb	/ (float)run_time_sec, metadata.n_adc_hits_B_dEb	/ (float)run_time_sec);
	printf("\nBottom E     : %8.2f%8.2f%8.2f", sTot_B_E		/ (float)sync_time_sec, metadata.n_tdc_hits_B_E		/ (float)run_time_sec, metadata.n_adc_hits_B_E	/ (float)run_time_sec);
	printf("\nLeft   dEa   : %8.2f%8.2f%8.2f", sTot_L_dEa	/ (float)sync_time_sec, metadata.n_tdc_hits_L_dEa	/ (float)run_time_sec, metadata.n_adc_hits_L_dEa	/ (float)run_time_sec);
	printf("\nLeft   dEb   : %8.2f%8.2f%8.2f", sTot_L_dEb	/ (float)sync_time_sec, metadata.n_tdc_hits_L_dEb	/ (float)run_time_sec, metadata.n_adc_hits_L_dEb	/ (float)run_time_sec);
	printf("\nLeft   E     : %8.2f%8.2f%8.2f", sTot_L_E		/ (float)sync_time_sec, metadata.n_tdc_hits_L_E		/ (float)run_time_sec, metadata.n_adc_hits_L_E	/ (float)run_time_sec);
	printf("\nRight  Ge    : %8.2f%8.2f%8.2f", sTot_R_ge	/ (float)sync_time_sec, metadata.n_tdc_hits_R_ge		/ (float)run_time_sec, metadata.n_adc_hits_R_ge	/ (float)run_time_sec);
	printf("\nTop    Ge    : %8.2f%8.2f%8.2f", sTot_T_ge	/ (float)sync_time_sec, metadata.n_tdc_hits_T_ge		/ (float)run_time_sec, metadata.n_adc_hits_T_ge	/ (float)run_time_sec);
	printf("\nRight  MCP   : %8.2f%8.2f"	 , sTot_R_mcp	/ (float)sync_time_sec, metadata.n_tdc_hits_R_mcp	/ (float)run_time_sec);
	...
	printf("\nTop    MCP   : %8.2f%8.2f"	 , sTot_T_mcp	/ (float)sync_time_sec, metadata.n_tdc_hits_T_mcp	/ (float)run_time_sec);
