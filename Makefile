...
CXX = g++
CXXFLAGS = -c -g -O2 $(ROOTCFLAGS) -I/opt/scarlet-3.x/include -I/opt/ktool-2.0/include -I/home/siegl/codes/BDNsort #$(INCDIRS)
...
bdn_sort_20140714: bdn_sort_20140714.o bdn_histograms.o bdn_trees_20140613.o CSVtoStruct.o mcpGridCorrection.o
	$(CXX) $^ -o $@ $(LIBS) $(ROOTLIBS)
